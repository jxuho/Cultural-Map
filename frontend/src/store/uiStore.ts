...
const useUiStore = create<UiState>()(
  devtools((set) => ({
    ...
    openSidePanel: (placeInfo) =>
      set({ isSidePanelOpen: true, selectedPlace: placeInfo }),
    closeSidePanel: () => set({ isSidePanelOpen: false, selectedPlace: null }),
    clearSelectedPlace: () => set({ selectedPlace: null }),
    isUserProfileOpen: false,
    userProfileId: null,
    openUserProfile: (userId) =>
      set({ isUserProfileOpen: true, userProfileId: userId }),
    closeUserProfile: () =>
      set({ isUserProfileOpen: false, userProfileId: null }),
    ...
    setNearbySitesLoading: (isLoading) =>
      set({ nearbySitesLoading: isLoading }),
    ...
    closeCreateForm: () =>
      set({ isCreateFormOpen: false, createFormData: null }),
    ...
    closeUpdateForm: () =>
      set({ isUpdateFormOpen: false, updateFormData: null }),
